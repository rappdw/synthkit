...
description: >
  ...
  or any request to apply CISO-level scrutiny. Also use when the user says "/ciso-review".
---
...
When the user invokes `/ciso-review [subject]`, start by collecting what you need. If the user
