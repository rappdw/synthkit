...
description: >
  ...
  work through over multiple sessions", or "/init-discovery". This is the multi-session
  counterpart to /explore-with-me — use explore-with-me for single-session explorations and
